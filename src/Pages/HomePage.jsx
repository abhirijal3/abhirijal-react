                    ...
                    <div className="position-absolute" style={{ 'top': '450px' }}>
                        <div>
                            <button type="button" className="btn btn-primary bg-red border-red font-manrope" style={{ 'white-space': 'nowrap' }}>About Me <svg style={{ 'height': '25px', 'width': '25px' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g>
                                    <path d="M20 12L4 12" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M14 18L19.9375 12.0625V12.0625C19.972 12.028 19.972 11.972 19.9375 11.9375V11.9375L14 6" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </g>
                            </svg></button>
                        </div>
                    </div>
