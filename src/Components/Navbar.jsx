                    ...
                    <div className="offcanvas-body">
                        <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li className="nav-item me-lg-4">
                                <Link className="nav-link active font-karla" style={{ 'fontSize': '18px' }} aria-current="page" to={'/'}>Home</Link>
                            </li>
                            <li className="nav-item mx-lg-4">
                                <Link className="nav-link font-karla" style={{ 'fontSize': '18px' }} to={'/about'}>About</Link>
                            </li>
                            <li className="nav-item mx-lg-4">
                                <Link className="nav-link font-karla" style={{ 'fontSize': '18px' }} to={'/projects'}>Projects</Link>
                            </li>
                            <li className="nav-item ms-lg-4">
                                <Link className="nav-link font-karla" style={{ 'fontSize': '18px' }} to={'/'}>Contact</Link>
                            </li>
                        </ul>
                    </div>
                </div>
